...
def main(full_path_to_file):
    ...
    base_data = force_plate[0:baseline_length]
    base_ave = np.average(base_data)
    baseline += base_ave
    ...
    for index in range(first_landing_index + 10, len(force_plate_list)):
        ...
        ### your code here ###
        take_off = force_plate_list[index]

        if take_off < baseline + delta:
    ...
    for index in range(take_off_index + 10, len(force_plate_list)):
        ...
        ### your code here ###
        second_landing = force_plate_list[index]

        if second_landing > baseline + delta:
